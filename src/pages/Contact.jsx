                ...
                <div className="relative max-w-7xl mx-auto px-4 py-24 lg:py-32">
                    <div className="text-center max-w-5xl mx-auto">
                        <div className="inline-flex items-center gap-3 px-6 py-2 bg-blue-600/20 backdrop-blur-sm rounded-full border border-white/20 mb-8">
                            ...
                            <span className="text-blue-300 font-semibold tracking-wider">24/7 GLOBAL SUPPORT · 2 HOUR RESPONSE</span>
                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row gap-6 justify-center">
                            <a
                                ...
                                className="px-8 py-4 bg-white text-blue-600 font-bold rounded-full hover:bg-slate-100 transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 inline-flex items-center gap-3"
                            >
                ...
                <div className="max-w-7xl mx-auto px-4">
                    <div className="grid lg:grid-cols-2 gap-16">
                                ...
                                <form onSubmit={handleSubmit} className="space-y-6">
                                    <div className="grid md:grid-cols-2 gap-6">
                                        <div>
                                            ...
                                            <input
                                                ...
                                                className="w-full px-5 py-4 border border-slate-300 rounded-xl focus:border-blue-500 focus:ring-4 focus:ring-blue-100 outline-none transition-all"
                                    ...
                                    <div>
                                        ...
                                        <textarea
                                            ...
                                            required
                                            onChange={handleChange}
                                            className="w-full px-5 py-4 border border-slate-300 rounded-xl focus:border-blue-500 focus:ring-4 focus:ring-blue-100 outline-none transition-all resize-none"
                                            placeholder="Tell us how we can help..."
                                        />
                                    </div>
                                    <button
                                        type="submit"
                                        className="w-full py-5 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-bold rounded-xl hover:from-blue-700 hover:to-blue-800 transition-all shadow-lg hover:shadow-2xl flex items-center justify-center gap-3 text-lg"
                                    >
                        ...
                        <div className="space-y-8">
                            <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-3xl p-10 text-center">
                                ...
                                <p className="text-blue-100">For active incidents · Average pickup: 18 seconds</p>
                            </div>
                ...
                <div className="max-w-7xl mx-auto px-4">
                    ...
                    <div className="grid md:grid-cols-3 gap-10">
                        {offices.map((office, idx) => (
                            <div
                                key={idx}
                                className="group bg-white rounded-3xl overflow-hidden border border-slate-200 hover:border-blue-300 hover:shadow-2xl transition-all duration-500"
                            >
                                <div className="relative h-64 overflow-hidden">
                                    ...
                                    <div className="absolute bottom-6 left-6 text-white">
                                        ...
                                        <p className="text-blue-300">{office.city}</p>
                                    </div>
                                </div>
                                <div className="p-8">
                                    <div className="space-y-4 text-slate-600">
                                        ...
                                        <div className="flex items-center gap-3">
                                            ...
                                            <a href={`mailto:${office.email}`} className="hover:text-blue-600 transition-colors text-sm">
                                                {office.email}
                                            </a>
                                        </div>
                                        <div className="flex items-center gap-3">
                                    ...
                                    <a href="#" className="mt-6 inline-flex items-center text-blue-600 font-bold gap-2 group-hover:gap-4 transition-all">
                                        Get Directions
                ...
                <div className="max-w-4xl mx-auto px-4 text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-6 justify-center">
                        <a
                            ...
                            className="px-10 py-5 bg-white text-blue-600 font-bold rounded-full hover:bg-slate-100 transition-all shadow-xl text-lg inline-flex items-center gap-3"
                        >
