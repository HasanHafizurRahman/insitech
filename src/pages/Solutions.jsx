                    ...
                    <div className="grid md:grid-cols-3 gap-10">
                        {industries.map((ind, idx) => {
                            ...
                            return (
                                <div
                                    key={idx}
                                    className="group bg-gradient-to-b from-slate-50 to-white rounded-3xl p-10 border border-slate-200 hover:border-blue-600 hover:shadow-2xl transition-all duration-500 text-center"
                                >
